...
% Define Colors
\definecolor{primary}{HTML}{63A002}          % Primary color
\definecolor{secondary}{HTML}{85976E}        % Secondary color
\definecolor{links}{HTML}{1565C0}            % Links color
\definecolor{accent}{HTML}{263238}           % Accent color 
\definecolor{surface}{HTML}{e2e3d8}          % Surface color
\definecolor{teriary}{HTML}{004B48}          % Surface color
...
\section{\faBusinessTime}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeEntryDesc{Leading a cross-functional team of 11 developers responsible for the software on EGYM Smart Strength machines and its cloud integration. Focused on optimizing team processes to improve development flow efficiency and removing obstacles to allow developers to concentrate on their core tasks. Scaled the team from 5 to 11 members while ensuring continuous support for individual career development. Continues to actively contribute as a developer, writing Go and Java code to support backend development and ensuring robust, scalable solutions}
    \resumeItemListStart
    \resumeItem {Taking leadership and people responsibility for the team, ensuring alignment with company goals}
    \resumeItem {Supporting the company’s objectives by enabling the team to grow organically while maintaining and nurturing a positive team culture}
    \resumeItem {Providing guidance and support to developers to help them grow in their careers and progress through the career ladder}
